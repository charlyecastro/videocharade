...
docker run -d --name info441-charades --network messagesnetwork -e CHARADESADDR=":80" -e RABBITADDR="rabbitmq:5672" -e MQNAME=$MQNAME -e LEADERBOARDADDR=$DSN -p 8081:80 charlyecastro/charades
